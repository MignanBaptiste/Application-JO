#!/bin/bash
javac --source-path ./src/applicationJo/vues/ -d bin/ --module-path /usr/share/openjfx/lib/ --add-modules javafx.controls,javafx.fxml src/jo/*.java src/jo/sport/*.java src/jo/exception/*.java src/applicationJo/database/*.java src/applicationJo/vues/JeuxIUTOlympiques.java src/applicationJo/controleurs/*.java
